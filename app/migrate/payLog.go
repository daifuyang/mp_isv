...
func (m PayLog) AutoMigrate() {
	...
	flag := m.Db.Migrator().HasIndex(&PayLog{}, "gmt_payment")
	if flag {
		m.Db.Migrator().CreateIndex(&PayLog{}, "gmt_payment")
	}
	flag = m.Db.Migrator().HasIndex(&PayLog{}, "idx_gmt_payment")
	if flag {
		m.Db.Migrator().CreateIndex(&PayLog{}, "idx_gmt_payment")
	}
