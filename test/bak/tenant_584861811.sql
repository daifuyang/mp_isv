...
--
-- Host: rm-bp1sz0va1gb9943hjio.mysql.rds.aliyuncs.com    Database: tenant_584861811
-- ------------------------------------------------------
...
--
-- Current Database: `tenant_584861811`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `tenant_584861811` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `tenant_584861811`;
...
INSERT INTO `cmf_admin_user` VALUES (1,0,0,1626031512,0,0,1,'17816240515','07267e21c5cd2c9bd95324027b65cc8f','17816240515','','','','','17816240515','');
...
INSERT INTO `cmf_asset` VALUES (1,1,1056,1626031581,1,'f26cb2f6-4880-4963-68ae-94987beadcca','1625843289962.jpeg','7e95025089c2f09d90ecd8714dca1939.jpeg','default/20210712/7e95025089c2f09d90ecd8714dca1939.jpeg','jpeg',0,'',0);
...
INSERT INTO `cmf_mp_theme` VALUES (1,1563821632,0,'咖啡厅点单','',1,584861811,'default/20210712/7e95025089c2f09d90ecd8714dca1939.jpeg','','{}','','','','','',1626031587,0,10000,0);
...
INSERT INTO `cmf_option` VALUES (1,1,'business_info','{\"email\": \"\", \"mobile\": \"\", \"address\": \"\", \"company\": \"\", \"contact\": \"\", \"app_desc\": \"\", \"app_slogan\": \"\", \"brand_logo\": \"default/20210712/7e95025089c2f09d90ecd8714dca1939.jpeg\", \"brand_name\": \"咖啡厅点单\", \"out_door_pic\": \"\", \"alipay_logo_id\": \"\", \"business_photo\": \"\", \"business_scope\": \"\", \"business_expired\": \"\", \"business_license\": \"\", \"food_license_pic\": \"\", \"mini_category_ids\": \"XS1009_XS2075\"}',1563821632,0);
...
INSERT INTO `cmf_portal_category` VALUES (1,1563821632,0,0,1,0,10000,'新鲜事','','','','','','','','','','');
...
INSERT INTO `cmf_role` VALUES (1563821632,1,0,'超级管理员','拥有网站最高管理员权限！',10000,1626031588,1626031588,1),(1563821632,2,0,'收银员','收银员！',1,1626031588,1626031588,1),(1563821632,3,0,'财务','财务！',2,1626031588,1626031588,1);
...
--
-- Dumping events for database 'tenant_584861811'
--
...
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `memberOrderCloseStatus` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-12 03:25:12' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_member_card_order SET order_status = 'TRADE_CLOSED' WHERE order_status = 'WAIT_BUYER_PAY' AND UNIX_TIMESTAMP(NOW()) > create_at + 600 */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `memberStatus` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-12 03:25:12' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_member_card SET status = -1 WHERE end_at between 0 AND UNIX_TIMESTAMP(NOW()) */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `orderCloseStatus` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-12 03:25:11' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_food_order SET order_status = 'TRADE_CLOSED' WHERE order_status = 'WAIT_BUYER_PAY' AND UNIX_TIMESTAMP(NOW()) > create_at + 600 */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `rechargeOrderCloseStatus` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-12 03:25:12' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_recharge_order SET order_status = 'TRADE_CLOSED' WHERE order_status = 'WAIT_BUYER_PAY' AND UNIX_TIMESTAMP(NOW()) > create_at + 600 */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `voucher` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-12 03:25:12' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_voucher SET status = 2 WHERE UNIX_TIMESTAMP(publish_end_time) < UNIX_TIMESTAMP(NOW()) */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `voucherPost` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-12 03:25:12' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_voucher_post SET status = 2 WHERE valid_end_at < UNIX_TIMESTAMP(NOW()) */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
--
-- Dumping routines for database 'tenant_584861811'
--
...
-- Dump completed on 2021-11-07 15:06:27
