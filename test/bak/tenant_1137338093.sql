...
--
-- Host: rm-bp1sz0va1gb9943hjio.mysql.rds.aliyuncs.com    Database: tenant_1137338093
-- ------------------------------------------------------
...
--
-- Current Database: `tenant_1137338093`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `tenant_1137338093` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `tenant_1137338093`;
...
INSERT INTO `cmf_admin_user` VALUES (1,0,0,1627459834,0,0,1,'15133437998','3ab86f1c5c2985a960a7a3894d0d1f28','15133437998','','','','','15133437998','');
...
INSERT INTO `cmf_asset` VALUES (1,1,7428,1627460070,1,'9ec4e046-9329-4325-44ed-922209371dbb','046dbbe64c7c605348b08aea1bb311cc_1.jpg','6a78d8852840b5dbf5e29b423c55b1f6.jpg','default/20210728/6a78d8852840b5dbf5e29b423c55b1f6.jpg','jpg',0,'',0);
...
INSERT INTO `cmf_mp_theme` VALUES (1,1480399341,0,'冰冰的黑粉店','',1,1137338093,'default/20210728/6a78d8852840b5dbf5e29b423c55b1f6.jpg','','{}','','','','','',1627460084,0,10000,0);
...
INSERT INTO `cmf_option` VALUES (1,1,'business_info','{\"email\": \"\", \"mobile\": \"\", \"address\": \"\", \"company\": \"\", \"contact\": \"\", \"app_desc\": \"\", \"app_slogan\": \"\", \"brand_logo\": \"default/20210728/6a78d8852840b5dbf5e29b423c55b1f6.jpg\", \"brand_name\": \"冰冰的黑粉店\", \"out_door_pic\": \"\", \"alipay_logo_id\": \"\", \"business_photo\": \"\", \"business_scope\": \"\", \"business_expired\": \"\", \"business_license\": \"\", \"food_license_pic\": \"\", \"mini_category_ids\": \"XS1009_XS2076\"}',1480399341,0);
...
INSERT INTO `cmf_portal_category` VALUES (1,1480399341,0,0,1,0,10000,'新鲜事','','','','','','','','','','');
...
INSERT INTO `cmf_role` VALUES (1480399341,1,0,'超级管理员','拥有网站最高管理员权限！',10000,1627460084,1627460084,1),(1480399341,2,0,'收银员','收银员！',1,1627460084,1627460084,1),(1480399341,3,0,'财务','财务！',2,1627460084,1627460084,1);
...
INSERT INTO `cmf_third_part` VALUES (1,370429601,'alipay-mp',0,'2088612395266846',''),(2,1661227707,'wechat-mp',0,'orGm04udVmDjU2q3t67WVSxdAJPE','dZ2t9UrVB6Tg0CZv8GAdRQ=='),(3,1661227707,'alipay-mp',0,'2088141419408923',''),(4,2059868464,'alipay-mp',0,'2088002784196294',''),(5,2059868464,'alipay-mp',0,'2088102080680326',''),(6,1661227707,'wechat-mp',0,'orGm04mBsntRz6RLbtqCOk3htELU','t3E6vSkoHT7YpBy9aptI0w=='),(7,298190799,'alipay-mp',0,'2088042865655966',''),(8,215329371,'wechat-mp',0,'oeKQ15aTNy8WFsRn0wIG7kdcYJc4','sTiouhpCY0In9jA3fWssfg=='),(9,370429601,'alipay-mp',0,'2088622871840897',''),(10,370429601,'alipay-mp',0,'2088222468178781',''),(11,370429601,'alipay-mp',0,'2088232243656661',''),(12,298190799,'alipay-mp',0,'2088802500687105',''),(13,298190799,'alipay-mp',0,'2088702830037585',''),(14,1661227707,'wechat-mp',0,'orGm04tUMikH3KtU70ghDl9wD8XU','bEv9uHrguBEu27lAAFFw3g=='),(15,2059868464,'wechat-mp',0,'o3WpN46fM2fetSRZB4FkuONIteA8','EHE/vFRb1UQnVJoAskLc9w=='),(16,215329371,'alipay-mp',0,'2088512446596714','');
...
--
-- Dumping events for database 'tenant_1137338093'
--
...
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `memberOrderCloseStatus` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-28 16:10:34' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_member_card_order SET order_status = 'TRADE_CLOSED' WHERE order_status = 'WAIT_BUYER_PAY' AND UNIX_TIMESTAMP(NOW()) > create_at + 600 */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `memberStatus` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-28 16:10:34' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_member_card SET status = -1 WHERE end_at between 0 AND UNIX_TIMESTAMP(NOW()) */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `orderCloseStatus` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-28 16:10:33' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_food_order SET order_status = 'TRADE_CLOSED' WHERE order_status = 'WAIT_BUYER_PAY' AND UNIX_TIMESTAMP(NOW()) > create_at + 600 */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `rechargeOrderCloseStatus` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-28 16:10:34' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_recharge_order SET order_status = 'TRADE_CLOSED' WHERE order_status = 'WAIT_BUYER_PAY' AND UNIX_TIMESTAMP(NOW()) > create_at + 600 */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `voucher` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-28 16:10:34' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_voucher SET status = 2 WHERE UNIX_TIMESTAMP(publish_end_time) < UNIX_TIMESTAMP(NOW()) */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`mp_isv`@`%`*/ /*!50106 EVENT `voucherPost` ON SCHEDULE EVERY 1 SECOND STARTS '2021-07-28 16:10:34' ON COMPLETION NOT PRESERVE ENABLE DO UPDATE cmf_voucher_post SET status = 2 WHERE valid_end_at < UNIX_TIMESTAMP(NOW()) */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
--
-- Dumping routines for database 'tenant_1137338093'
--
...
-- Dump completed on 2021-11-07 15:07:17
